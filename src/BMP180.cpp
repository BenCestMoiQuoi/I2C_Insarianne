...
void BMP180::readSealevelPressure(float altitude_meters) {
  SeaLevelPressure = (int64_t)(Pressure / pow(1.0 - altitude_meters / 44330, 5.255));
}
...
void BMP180::readAltitude(float sealevelPressure) {
